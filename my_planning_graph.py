...
class PlanningGraph():
    ...
    def __init__(self, problem: Problem, state: str, serial_planning=True):
        ...
        Instance variable calculated:
            fs: FluentState
                the state represented as positive and negative fluent literal
                lists
    ...
    def add_action_level(self, level):
        ...
        # for the problem and add a PgNode_a to a_levels[0]
        #   set iff all prerequisite literals for the action hold in S0.
        #   This can be accomplished by testing
        #   to see if a proposed PgNode_a has prenodes that are a subset of the
        #   previous S level. Once an
    ...
    def add_literal_level(self, level):
        ...
        #   produced by the action. These literals will all be part of the
        #   new S level. Since we are working with sets, they
        #   may be "added" to the set without fear of duplication.
        #   However, it is important to then correctly create and connect
